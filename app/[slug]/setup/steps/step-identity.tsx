...
export default function StepIdentity({ state, onChange, error }: Props) {
  const { complianceFlags } = useTenantConfig();
  const nameLabel = 'Business Name';
  ...
  return (
    <div className="space-y-4">
      ...
      {complianceFlags.show_kvk_field && (
        <div>
