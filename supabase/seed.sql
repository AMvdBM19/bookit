...
INSERT INTO service_tags (id, tenant_id, name, description, extra_price, display_order) VALUES
  ('tag11111-0001-0001-0001-000000000001', '11111111-1111-1111-1111-111111111111', 'Traditional', 'Classic bold lines and colors', 0.00, 1),
  ('tag11111-0002-0002-0002-000000000002', '11111111-1111-1111-1111-111111111111', 'Fine Line', 'Delicate, detailed linework', 0.00, 2),
  ('tag11111-0003-0003-0003-000000000003', '11111111-1111-1111-1111-111111111111', 'Blackwork', 'Bold black ink designs', 0.00, 3),
  ('tag11111-0004-0004-0004-000000000004', '11111111-1111-1111-1111-111111111111', 'Realism', 'Photo-realistic portrait and detail work', 20.00, 4),
  ('tag11111-0005-0005-0005-000000000005', '11111111-1111-1111-1111-111111111111', 'Geometric', 'Sacred geometry and patterns', 0.00, 5),
  ('tag11111-0006-0006-0006-000000000006', '11111111-1111-1111-1111-111111111111', 'Japanese', 'Traditional Japanese irezumi', 10.00, 6),
  ('tag11111-0007-0007-0007-000000000007', '11111111-1111-1111-1111-111111111111', 'Cover-up', 'Cover existing tattoo (price varies)', 30.00, 7);
...
INSERT INTO staff (id, tenant_id, pseudonym, real_name, age, nationality, gender, languages, bio, photo_urls, social_links, status, btw_exempt, wizard_completed, first_login, created_by_agent_id) VALUES
  ('stf11111-0001-0001-0001-000000000001', '11111111-1111-1111-1111-111111111111',
   ...
   'aaaa1111-aaaa-aaaa-aaaa-aaaaaaaaaaaa'),
  ('stf11111-0002-0002-0002-000000000002', '11111111-1111-1111-1111-111111111111',
...
INSERT INTO staff_service_tags (staff_id, tag_id, tenant_id) VALUES
  ('stf11111-0001-0001-0001-000000000001', 'tag11111-0001-0001-0001-000000000001', '11111111-1111-1111-1111-111111111111'),
  ('stf11111-0001-0001-0001-000000000001', 'tag11111-0002-0002-0002-000000000002', '11111111-1111-1111-1111-111111111111'),
  ('stf11111-0001-0001-0001-000000000001', 'tag11111-0005-0005-0005-000000000005', '11111111-1111-1111-1111-111111111111'),
  ('stf11111-0002-0002-0002-000000000002', 'tag11111-0003-0003-0003-000000000003', '11111111-1111-1111-1111-111111111111'),
  ('stf11111-0002-0002-0002-000000000002', 'tag11111-0005-0005-0005-000000000005', '11111111-1111-1111-1111-111111111111'),
  ('stf11111-0002-0002-0002-000000000002', 'tag11111-0006-0006-0006-000000000006', '11111111-1111-1111-1111-111111111111'),
  ('stf11111-0002-0002-0002-000000000002', 'tag11111-0007-0007-0007-000000000007', '11111111-1111-1111-1111-111111111111');
...
INSERT INTO staff_schedule (tenant_id, staff_id, day_of_week, start_time, end_time) VALUES
  ...
  ('11111111-1111-1111-1111-111111111111', 'stf11111-0001-0001-0001-000000000001', 2, '10:00', '18:00'),
  ('11111111-1111-1111-1111-111111111111', 'stf11111-0001-0001-0001-000000000001', 3, '10:00', '18:00'),
  ('11111111-1111-1111-1111-111111111111', 'stf11111-0001-0001-0001-000000000001', 4, '10:00', '18:00'),
  ('11111111-1111-1111-1111-111111111111', 'stf11111-0001-0001-0001-000000000001', 5, '10:00', '18:00'),
  ('11111111-1111-1111-1111-111111111111', 'stf11111-0001-0001-0001-000000000001', 6, '10:00', '16:00'),
  -- Kai: Mon-Fri 12:00-20:00
  ('11111111-1111-1111-1111-111111111111', 'stf11111-0002-0002-0002-000000000002', 1, '12:00', '20:00'),
  ('11111111-1111-1111-1111-111111111111', 'stf11111-0002-0002-0002-000000000002', 2, '12:00', '20:00'),
  ('11111111-1111-1111-1111-111111111111', 'stf11111-0002-0002-0002-000000000002', 3, '12:00', '20:00'),
  ('11111111-1111-1111-1111-111111111111', 'stf11111-0002-0002-0002-000000000002', 4, '12:00', '20:00'),
  ('11111111-1111-1111-1111-111111111111', 'stf11111-0002-0002-0002-000000000002', 5, '12:00', '20:00');

-- Guest clients — inkhaus
INSERT INTO guest_clients (id, tenant_id, email, name, phone, wa_opt_in, booking_count, last_seen_at) VALUES
  ('gst11111-0001-0001-0001-000000000001', '11111111-1111-1111-1111-111111111111',
   'emma@example.com', 'Emma Visser', '+31612111001', TRUE, 2, NOW() - INTERVAL '5 days'),
  ('gst11111-0002-0002-0002-000000000002', '11111111-1111-1111-1111-111111111111',
...
INSERT INTO bookings (
  ...
  ('bkk11111-0001-0001-0001-000000000001', '11111111-1111-1111-1111-111111111111',
   'stf11111-0001-0001-0001-000000000001', 'gst11111-0001-0001-0001-000000000001', 'client_request',
  ...
  -- Confirmed upcoming
  ('bkk11111-0002-0002-0002-000000000002', '11111111-1111-1111-1111-111111111111',
   'stf11111-0002-0002-0002-000000000002', 'gst11111-0002-0002-0002-000000000002', 'client_request',
  ...
  ('bkk11111-0003-0003-0003-000000000003', '11111111-1111-1111-1111-111111111111',
   'stf11111-0001-0001-0001-000000000001', 'gst11111-0001-0001-0001-000000000001', 'client_request',
...
INSERT INTO booking_service_tags (tenant_id, booking_id, tag_id, tag_name, extra_price) VALUES
  ('11111111-1111-1111-1111-111111111111', 'bkk11111-0001-0001-0001-000000000001', 'tag11111-0002-0002-0002-000000000002', 'Fine Line', 0.00),
  ('11111111-1111-1111-1111-111111111111', 'bkk11111-0002-0002-0002-000000000002', 'tag11111-0003-0003-0003-000000000003', 'Blackwork', 0.00),
  ('11111111-1111-1111-1111-111111111111', 'bkk11111-0002-0002-0002-000000000002', 'tag11111-0005-0005-0005-000000000005', 'Geometric', 0.00);
...
INSERT INTO agent_notifications (tenant_id, type, priority, message, linked_entity, linked_id, is_read, is_resolved) VALUES
  ('11111111-1111-1111-1111-111111111111', 'booking_request', 2,
   ...
   'booking', 'bkk11111-0003-0003-0003-000000000003', FALSE, FALSE);
...
INSERT INTO service_tags (id, tenant_id, name, description, extra_price, display_order) VALUES
  ('tag22222-0001-0001-0001-000000000001', '22222222-2222-2222-2222-222222222222', 'GFE', 'Girlfriend experience', 20.00, 1),
  ('tag22222-0002-0002-0002-000000000002', '22222222-2222-2222-2222-222222222222', 'Massage', 'Full body massage', 15.00, 2),
  ('tag22222-0003-0003-0003-000000000003', '22222222-2222-2222-2222-222222222222', 'Duo', 'Two workers together', 50.00, 3),
  ('tag22222-0004-0004-0004-000000000004', '22222222-2222-2222-2222-222222222222', 'Dinner Date', 'Dinner companion', 30.00, 4);

-- Workers — velours-demo (2 workers with social_links)
INSERT INTO staff (id, tenant_id, pseudonym, real_name, age, nationality, gender, languages, bio, photo_urls, social_links, status, btw_exempt, wizard_completed, first_login, created_by_agent_id) VALUES
  ('stf22222-0001-0001-0001-000000000001', '22222222-2222-2222-2222-222222222222',
   ...
   'active', FALSE, TRUE, FALSE,
   'bbbb2222-bbbb-bbbb-bbbb-bbbbbbbbbbbb'),
  ('stf22222-0002-0002-0002-000000000002', '22222222-2222-2222-2222-222222222222',
...
INSERT INTO staff_service_tags (staff_id, tag_id, tenant_id) VALUES
  ('stf22222-0001-0001-0001-000000000001', 'tag22222-0001-0001-0001-000000000001', '22222222-2222-2222-2222-222222222222'),
  ('stf22222-0001-0001-0001-000000000001', 'tag22222-0002-0002-0002-000000000002', '22222222-2222-2222-2222-222222222222'),
  ('stf22222-0001-0001-0001-000000000001', 'tag22222-0004-0004-0004-000000000004', '22222222-2222-2222-2222-222222222222'),
  ('stf22222-0002-0002-0002-000000000002', 'tag22222-0001-0001-0001-000000000001', '22222222-2222-2222-2222-222222222222'),
  ('stf22222-0002-0002-0002-000000000002', 'tag22222-0003-0003-0003-000000000003', '22222222-2222-2222-2222-222222222222');

-- Staff schedules — velours-demo
INSERT INTO staff_schedule (tenant_id, staff_id, day_of_week, start_time, end_time) VALUES
  ('22222222-2222-2222-2222-222222222222', 'stf22222-0001-0001-0001-000000000001', 1, '10:00', '22:00'),
  ('22222222-2222-2222-2222-222222222222', 'stf22222-0001-0001-0001-000000000001', 2, '10:00', '22:00'),
  ('22222222-2222-2222-2222-222222222222', 'stf22222-0001-0001-0001-000000000001', 3, '10:00', '22:00'),
  ('22222222-2222-2222-2222-222222222222', 'stf22222-0001-0001-0001-000000000001', 4, '10:00', '22:00'),
  ('22222222-2222-2222-2222-222222222222', 'stf22222-0001-0001-0001-000000000001', 5, '10:00', '22:00'),
  ('22222222-2222-2222-2222-222222222222', 'stf22222-0002-0002-0002-000000000002', 2, '12:00', '20:00'),
  ('22222222-2222-2222-2222-222222222222', 'stf22222-0002-0002-0002-000000000002', 3, '12:00', '20:00'),
  ('22222222-2222-2222-2222-222222222222', 'stf22222-0002-0002-0002-000000000002', 4, '12:00', '20:00'),
  ('22222222-2222-2222-2222-222222222222', 'stf22222-0002-0002-0002-000000000002', 5, '12:00', '20:00'),
  ('22222222-2222-2222-2222-222222222222', 'stf22222-0002-0002-0002-000000000002', 6, '12:00', '20:00');
...
INSERT INTO clients (id, tenant_id, display_name, real_name, email, phone, status, wa_opt_in, created_at, approved_at) VALUES
  ('cli22222-0001-0001-0001-000000000001', '22222222-2222-2222-2222-222222222222',
   'Mark V.', 'Mark Vermeer', 'mark@example.com', '+31620001111', 'approved', TRUE,
   NOW() - INTERVAL '30 days', NOW() - INTERVAL '29 days'),
  ('cli22222-0002-0002-0002-000000000002', '22222222-2222-2222-2222-222222222222',
...
INSERT INTO client_status_log (tenant_id, client_id, from_status, to_status, reason, changed_by, changed_by_agent_id) VALUES
  ('22222222-2222-2222-2222-222222222222', 'cli22222-0001-0001-0001-000000000001', NULL, 'pending', 'Pending agent review', 'system', NULL),
  ('22222222-2222-2222-2222-222222222222', 'cli22222-0001-0001-0001-000000000001', 'pending', 'approved', 'Approved by agent', 'bbbb2222-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'bbbb2222-bbbb-bbbb-bbbb-bbbbbbbbbbbb'),
  ('22222222-2222-2222-2222-222222222222', 'cli22222-0002-0002-0002-000000000002', NULL, 'pending', 'Pending agent review', 'system', NULL);
...
INSERT INTO bookings (
  ...
  ('bkk22222-0001-0001-0001-000000000001', '22222222-2222-2222-2222-222222222222',
   'stf22222-0001-0001-0001-000000000001', 'cli22222-0001-0001-0001-000000000001', 'client_request',
...
INSERT INTO booking_service_tags (tenant_id, booking_id, tag_id, tag_name, extra_price) VALUES
  ('22222222-2222-2222-2222-222222222222', 'bkk22222-0001-0001-0001-000000000001', 'tag22222-0001-0001-0001-000000000001', 'GFE', 20.00);
...
INSERT INTO agent_notifications (tenant_id, type, priority, message, linked_entity, linked_id, is_read, is_resolved) VALUES
  ('22222222-2222-2222-2222-222222222222', 'client_signup', 1,
   ...
   'client', 'cli22222-0002-0002-0002-000000000002', FALSE, FALSE);
